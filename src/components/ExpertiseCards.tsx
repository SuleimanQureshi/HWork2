...
const cards = [
    ...
    },
    {
        ...
        text: "We rely on a unique and well-established partner network throughout all of Italy, including legal, tax, and real estate professionals, allowing us to offer fully integrated and multidisciplinary support.",
    },
    {
