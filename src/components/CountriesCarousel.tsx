...
const CountriesCarousel = () => {
  ...
  const visaOptions: VisaOption[] = [
    ...
    },
    {
      ...
      description: 'Essential support solutions including document translation, legalisation, and company formation to ensure smooth personal and business operations in Italy.',
