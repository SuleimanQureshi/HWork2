        ...
        <section className="space-y-12">
          <div>
            <h2 className="text-[32px] font-bold text-brand-primary mb-4">
              1. Corporate Immigration
            </h2>
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Work Permits</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black">
              Empowering businesses to bring the world's best talent to Italy. In today's global economy, your
              competitive advantage depends on accessing skilled professionals wherever they are. We partner with
              multinational corporations and growing businesses to navigate Italy's complex work permit landscape with
              precision and efficiency. From EU Blue Cards for highly qualified workers to intra-company transfers and
              specialised assignments, our team handles every aspect of the immigration process — initial assessments,
              documentation preparation, government submissions, and permit collection. We ensure full compliance
              with Italian immigration law while minimising delays and administrative burdens, so your employees can
              start contributing to your Italian operations without unnecessary obstacles standing in their way.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Study Permits</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black mb-8">
              Turn your academic aspirations into an Italian reality. Italy's world-renowned universities and prestigious
              academic institutions have shaped generations of scholars, artists, and innovators. We guide international
              students through every step of the study permit process—from securing university enrollment and
              preparing visa applications to registering with local authorities upon arrival. Our team ensures all
              documentation meets Italian requirements, handles communication with consulates and immigration
              offices, and provides the practical support you need to transition smoothly into Italian academic life. With
              our expertise, you can focus on your studies while we handle the complexities of immigration compliance,
              ensuring you're fully prepared to begin your educational journey in Italy with confidence.
            </p>

            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Elective Residence Visa</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black mb-8">
            ...
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Visas for Investors and Entrepreneurs</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black mb-8">
            ...
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Family Reunification Visa</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black mb-8">
            ...
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Digital Nomad Visa</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black mb-8">
            ...
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Italian Citizenship</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black">
          ...
          <div>
            <h2 className="text-[32px] font-bold text-brand-primary mb-4">
              3. Document Procurement & Ancestry Research
            </h2>
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Italian Document Procurement</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black mb-8">
            ...
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Ancestry & Genealogical Research</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black">
          ...
          <div>
            ...
            <p className="text-[17px] leading-[1.65] text-black mb-8">
              Your gateway to Italian real estate, wherever your journey begins. Whether you're an international buyer dreaming of a Tuscan villa, a local family searching for the perfect home, or an investor seeking commercial opportunities across Italy, navigating the real estate market shouldn't feel overwhelming. From bustling urban centres to serene coastal towns, from residential sales to commercial ventures and comprehensive property management, we deliver tailored solutions that cater to your unique vision. Our multilingual team understands the complexities that both foreign and domestic clients face — the paperwork, the negotiations, the local regulations—and we simplify every step with transparency, expertise, and unwavering dedication to your success. We don't just find properties; we build lasting relationships, turning your real estate aspirations into reality with clear communication, honest guidance, and results you can trust. Your dream property in Italy is closer than you think.
            </p>
            ...
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Lease and Purchase Support</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black mb-8">
            ...
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Contract Review</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black">
          ...
          <div>
            ...
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Translation and Legalisation</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black mb-8">
            ...
            <ul className="mb-6">
              <li className="flex items-start mb-4">
                <span className="inline-block w-2 h-2 bg-black rounded-full mt-2.5 mr-3 flex-shrink-0"></span>
                <span className="text-[19px] font-semibold text-black">Company Setup</span>
              </li>
            </ul>
            <p className="text-[17px] leading-[1.65] text-black">
