                        ...
                        <div className="p-8 md:p-12">
                            ...
                            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                                {sub.full_description.split('\n').map((para, i) => {
                                    ...
                                    // Detect if the line acts like a header (short, no ending punctuation)
                                    const isHeader = para.trim().length < 80 && !/[.,:;!?]$/.test(para.trim());
                                    
                                    if (isHeader) {
                                        return (
                                            <h3 key={i} className="text-2xl font-bold text-red-900 mt-8 mb-4">
                                                {para}
                                            </h3>
                                        );
                                    }
